...
const app = express();
app.use(cors({origin : ['https://deploy-preview-10--amazing-gaufre-1ebc58.netlify.app/', 'http://localhost:8080/', 'https://genuine-pastelito-0e12dc.netlify.app/'], credentials: true, exposedHeaders: ['X-Access-Token']}))
